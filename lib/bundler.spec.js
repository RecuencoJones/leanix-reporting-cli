...
describe('Bundler', function () {
    var writeFileAsync = jest.spyOn(asyncHelpers, 'writeFileAsync').mockResolvedValue(undefined);
    var tarC = jest.spyOn(tar, 'c').mockResolvedValue(undefined);
    ...
    jest.spyOn(fs, 'readdirSync').mockReturnValue(['report.js', 'style.css', 'index.html']);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, bundler.bundle('output')];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('writes lxreport.json', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            expect(writeFileAsync).toHaveBeenCalledWith('output/lxreport.json', JSON.stringify({
                name: 'my-report',
                version: '1.0.0',
                author: 'Jane Doe',
                description: 'My report description',
    ...
    it('creates bundle.tgz', function () {
